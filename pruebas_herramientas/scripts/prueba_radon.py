...
def selecionar_directorio_proyecto() -> Path:
    ...
    ruta = filedialog.askdirectory(
        title="Selecciona la carpeta del proyecto python para analizar con Radon"
    )
...
def guardar_resultado_txt(contenido: str, nombre_proyecto: str) -> Path:
    ...
    ruta_fichero = carpeta_resultados / f"reultado_radon_{nombre_proyecto}_{timestap}.txt"
