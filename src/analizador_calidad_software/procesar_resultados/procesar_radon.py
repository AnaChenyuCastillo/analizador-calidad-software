...
def procesar_radon(ruta_txt: Path, ruta_proyecto: Path, lenguaje) -> dict:
    ...
    for linea in lineas:
        ...
        if seccion_actual == "RAW":
            ...
            elif texto.startswith("difficulty:") and archivo_actual != "":  
                datos_archivos[archivo_actual]["DIFICULTAD"] = texto.split(":", 1)[1].strip()  

            elif texto.startswith("effort:") and archivo_actual != "":  
                datos_archivos[archivo_actual]["ESFUERZO"] = texto.split(":", 1)[1].strip()  

            elif texto.startswith("bugs:") and archivo_actual != "":  
                datos_archivos[archivo_actual]["BUGS"] = texto.split(":", 1)[1].strip()  
