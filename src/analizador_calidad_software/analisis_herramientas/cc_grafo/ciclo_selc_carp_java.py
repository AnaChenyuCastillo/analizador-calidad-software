...
def ejectar_ciclomatico(ruta_directorio, lenguaje: str):
    ...
    for archivo in lista_archivos:
        ...
        try:
            ...
            print(lenguaje)
            if lenguaje.lower() == "java":
                ruta = repo_root / "src" / "analizador_calidad_software" / "analisis_herramientas" / "cc_grafo" / "ciclo_java.py"
            elif lenguaje.lower() == "python":
    ...
    nombre_arc=(os.path.basename(os.path.normpath(ruta_directorio)))+"_"+marca_tiempo+"_java.pdf"
